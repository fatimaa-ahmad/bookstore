...
const Footer = () => {
  return (
    <div>
      <div className="bg-purple-light flex flex-col flex-wrap gap-4 p-5 gap-2sm:items-center sm:justify-center  ">
        <div className="flex flex-row justify-between px-16 sm:flex-col ">
          ...
          <ul className="flex flex-col gap-2 p-2  font-semibold sm:flex-col md:flex-col ">
            ...
            <li className="flex gap-4 items-center justify-center ">
              ...
              <i class="social ri-instagram-line cursor-pointer text-2xl text-title-text"></i>
              <i class="social ri-linkedin-box-fill cursor-pointer text-2xl text-title-text"></i>
              <i class="social ri-twitter-x-line cursor-pointer text-2xl text-title-text"></i>
              <i class="social ri-youtube-fill cursor-pointer text-2xl text-title-text"></i>
            </li>
          </ul>
        </div>

        <p className="text-center  font-semibold text-title-text/70">
          COPYRIGHT © {new Date().getFullYear()} Fatima Ahmad - ALL RIGHTS
          RESERVED.
        </p>
      </div>
    </div>
