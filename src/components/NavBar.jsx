    ...
    <>
      <div
        className={`flex fixed justify-between top-0 w-full px-6 py-2 z-50 sm:px-3  sm:py-3 ${
          sticky ? "bg-purple-light" : "bg-gray"
        ...
        <span className="hidden sm:block">
          <i
            class="ri-menu-4-fill text-title-text text-2xl cursor-pointer p-1 transform ease-in-out duration-300"
      ...
      {Showmenu && (
        <div className="flex  fixed top-0 flex-col bg-white  resNav">
          <span>
            <i
              class="ri-close-fill text-title-text text-4xl cursor-pointer p-5 float-end"
              onClick={() => {
                setShowmenu(false);
              }}></i>
          </span>
