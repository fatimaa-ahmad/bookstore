        ...
        pagination={{
          ...
          renderBullet: function (index, className) {
            return (
              '<span class="' +
              className +
              '" style="background-color: theme(\'colors.purple-dark\');"></span>'
            );
          },
        }}
        mousewheel={true}
          ...
          <div className="bg-gray    flex flex-wrap justify-between px-20 mt-12 pt-6 sm:mt-12 sm:px-6">
            <div className="hero animate-fade-down animate-ease-in-out animate-normal animate-fill-both gap-4 w-[50%] md:w-full sm:w-full flex flex-col p-1  justify-center leading-relaxed">
              ...
              <div className="btn float-left">
                <Link to="/book">
                  <button className="rounded border ms-2 text-title-text  float-start w-36 px-3 py-2 border-purple-dark/90 duration-300  hover:bg-purple-dark hover:text-white mt-4 ease-in-out font-semibold">
                    Explore Now
                  </button>
                </Link>
              </div>
            ...
            <div className="w-[45%] mt-5 animate-fade-up animate-ease-in-out animate-normal animate-fill-both lg:w-[50%] md:w-full sm:w-full sm:mt-0">
              <img
                src={book}
                alt="book"
                className=" float-right me-5 heroimg drop-shadow-[0_5px_7px_#4B0082] mt-[-20px]  lg:w-[70%] xl:w-[70%]  2xl:w-[80%]  "
              />
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-purple-light animate-fade-down animate-ease-in-out animate-normal animate-fill-both   flex flex-wrap justify-between px-20 mt-12 pt-6 sm:mt-12 sm:px-6">
