    ...
    <>
      <div className=" contact mt-10 flex items-center justify-center ">
        <div className="animate-fade-down animate-ease-in-out animate-normal animate-fill-both p-3 m-10 w-2/4 sm:w-full ">
          <form
            action="sumbit"
            className=" flex flex-col formContact  bg-purple-light/50 px-8 py-3 rounded-lg gap-2 ">
            ...
            <div className="float-end pe-1 py-3">
              <button
                type="submit"
                className="bg-purple-dark/80 hover:bg-purple-dark transform duration-200 ease float-end text-white text-sm border border-title-text/50 w-max p-2 rounded">
                Submit
              </button>
            </div>
          </form>
